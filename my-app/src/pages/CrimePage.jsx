...
export default function CrimePage() {
  ...
  return (
    <div className="app-root">
      <header className="app-header" style={{ background: "linear-gradient(135deg, #93c5fd 0%, #60a5fa 100%)", color: "#000" }}>
      ...
      <div className="life-page crime-page">
        <div style={{ marginBottom: "20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <button
            ...
            onClick={() => navigate("/")}
            style={{ fontSize: "15px", padding: "10px 18px", background: "#93c5fd", color: "#1e3a8a" }}
          >
            ← 홈으로 돌아가기
          </button>
        </div>
